...
import { View, Text, TouchableWithoutFeedback, TouchableHighlight, Keyboard, StyleSheet, ScrollView } from "react-native";
...
export default class AdminBookTab extends Component {
  constructor(props) {
    super(props);
  ...
  validateFields = () => {
    ...
    const fields = [
      ...
      recurringBooking === "Recurring" ?
        {
          condition: endDateText === "" || weekday === "",
          key: "recurringSettingsErrorMsg",
          errorMsg: "Recurring Settings not set!"
        }
        :
        {},
  ...
  navigateToReviewScreen = () => {
    ...
    this.props.navigation.push(Screens.AdminReviewBooking, {
      ...
      <AdminBookTabHOC serviceProviderType={serviceProviderType}>
        <ScrollView style={styles.screen}>
          <DatePicker
            ...
            maxDate={endDateText === "" ? null : moment(this.state.endDateText).toDate()}
          />
          <TimePicker
            value={timeText}
            ...
            serviceProviderType === ServiceProviderType.PASSENGER ?
              ...
              <>
                ...
                {/* <FlatList
                  ...
                  renderItem={({ item }) => <SelectedVehicleItem vehicle={item} />}
                /> */}
                {
              ...
              <>
                <NavigationInput
                  ...
                  onPress={() => {
                    ...
                    this.props.navigation.push(Screens.AdminRecurring, {
                      serviceProviderType: this.serviceProviderType,
