...
const RplDetailPicker = ({ navigation, route }) => {
          ...
          <View style={styles.Overallbackgroundcontainer}>
            ...
            <View style={styles.backgroundcontainer}>
              ...
              <TextInput style={styles.textStyle} keyboardType="number-pad"
                placeholder="Select Number of Load" onChangeText={text => setText(text)}
                defaultValue={text}
              />
            </View>
          </View>
          <View style={{ marginTop: 300 }}>
            <TouchableOpacity onPress={() => navigation.navigate(Screens.UnitFerryScheduledTimings, { route: selectedroute })} style={styles.ButtonSubmit}>
...
export default RplDetailPicker;
