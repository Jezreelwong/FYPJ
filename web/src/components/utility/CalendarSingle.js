...
function CalendarSingle() {
    function c(passed_month, passed_year, calNum) {
        ...
        clickedElement.on("click", function () {
            ...
            if(document.getElementById("scheduleSelectedDates") !== null){
                let scheduleElement = document.getElementById("scheduleSelectedDates");
                if(Object.keys(selected).length !== 0){
                    ...
                    scheduleElement.setAttribute("data-date", startYear + "-" + formatIfLT10(parseInt(startMonth) + 1) + "-" + formatIfLT10(startDate));
                    scheduleElement.click();
                }
                else{
                    scheduleElement.setAttribute("data-date", "");
                    scheduleElement.click();
                }
            }
            selectDates(selected);
